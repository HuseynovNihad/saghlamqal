...
Future<void> initAuth(GetIt sl) async {
  ...
  sl.registerLazySingleton(() => GoogleLoginUsecase(sl<IAuthRepository>()));
  ...
  sl.registerLazySingleton(() => CompleteProfileUsecase(sl<IAuthRepository>()));
  ...
  sl.registerFactory(
    () => AuthBloc(
      ...
      googleLogin: sl<GoogleLoginUsecase>(),
